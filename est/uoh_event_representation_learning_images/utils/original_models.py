...
class Classifier(nn.Module):
    def __init__(self,
                 voxel_dimension=(9,128,128), #voxel_dimension=(9,180,240),   dimension of voxel will be C x 2 x H x W
    ...
    def forward(self, x, img_path):
        ...
        #plt.imshow(representation_vizualization.permute(1, 2, 0)  )
        #plt.show()


        representation_vizualization = create_image(vox_cropped)

        #print(type(representation_vizualization))
        #print(representation_vizualization)
        #print(representation_vizualization.shape)
